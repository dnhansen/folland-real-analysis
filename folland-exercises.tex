...
\begin{remarkbreak}[Induced vector space topologies]
	...
	To see this, notice that, for $x \in X$ and $\epsilon > 0$,
	%
	\begin{align*}
		U_{x T \epsilon}
			&= \set{ y \in X }{ p_T(y-x) < \epsilon } \\
			&= \set[\big]{ y \in X }{ \norm{Ty-Tx} < \epsilon } \\
			&= T\preim \bigl( B_\epsilon(Tx) \bigr).
	\end{align*}
	%
